...
const ProductItem = ({
  ...
  return (
    <div className="flex flex-col items-center gap-y-2">
      ...
      <Link
        href={`/product/${product?.id}`}
        className="block flex justify-center items-center w-full uppercase bg-white px-0 py-2 text-base border border-gray-300 font-bold text-blue-600 shadow-sm hover:bg-gray-100 focus:outline-none focus:ring-2"
      >
        <p>View product</p>
      </Link>
    </div>
